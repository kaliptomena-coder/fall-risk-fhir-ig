# Resource Fall Risk Assessment Implementation Guide
...
```json
{
  ...
  "id" : "hl7.fhir.uv.fall-risk",
  "language" : "en",
  "url" : "https://example.org/fhir/fall-risk/ImplementationGuide/hl7.fhir.uv.fall-risk",
  "version" : "0.1.0",
  "name" : "FallRiskAssessmentIG",
  "title" : "Fall Risk Assessment Implementation Guide",
  "status" : "draft",
  ...
  "description" : "Interoperable FHIR-based fall risk assessment for older adults using standardized scoring, objective performance tests, and EHR-derived data.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "packageId" : "hl7.fhir.uv.fall-risk",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://example.org/fhir/fall-risk/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "name" : "Example Patient – Maria Müller",
    ...
    },
    {
      ...
      "name" : "Example – ADL Independence",
      "description" : "Observation capturing the patient's functional independence level (slight assistance needed) — scores 1 pt.",
      "exampleCanonical" : "https://example.org/fhir/fall-risk/StructureDefinition/fall-risk-factor-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Bundle/fall-risk-bundle-example"
      },
      "name" : "Example – Complete Fall Risk Assessment Bundle",
      "description" : "A Bundle containing all FHIR resources for a single fall risk assessment session.\nThis Bundle can be sent to any FHIR R4 server in one request.",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Condition/condition-fall-risk"
      },
      "name" : "Example – Condition: At Risk of Falls",
    ...
    },
    {
      ...
      "name" : "Example – Fall Risk Score 20/34)",
      "description" : "Aggregated fall risk score of 20 out of 34 — Moderate risk (score band 12–22).",
      "exampleCanonical" : "https://example.org/fhir/fall-risk/StructureDefinition/fall-risk-score-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example – Fall Risk Screening Result",
      "description" : "Overall fall risk classification: Moderate.",
      "exampleCanonical" : "https://example.org/fhir/fall-risk/StructureDefinition/fall-risk-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "name" : "Example – Falls History QuestionnaireResponse",
    ...
    },
    {
      ...
      "name" : "Example – Sit to Stand (30 s)",
      "description" : "Patient completed 8 repetitions in 30 seconds — scores 1 pt (8–11 band).",
      "exampleCanonical" : "https://example.org/fhir/fall-risk/StructureDefinition/fall-risk-performance-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/fall-risk-category-vs"
      },
      "name" : "Fall Risk Category ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/fall-risk-factor-observation"
      },
      "name" : "Fall Risk Factor Observation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/fall-risk-factors-vs"
      },
      "name" : "Fall Risk Factors ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/fall-risk-codes"
      },
      "name" : "Fall Risk Local Code System",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/fall-risk-observation"
      },
      "name" : "Fall Risk Observation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/fall-risk-performance-observation"
      },
      "name" : "Fall Risk Performance Test Observation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/fall-risk-performance-tests-vs"
      },
      "name" : "Fall Risk Performance Tests ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/fall-risk-score-observation"
      },
      "name" : "Fall Risk Score Observation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ConceptMap/fall-risk-score-threshold-map"
      },
      "name" : "Fall Risk Score Threshold ConceptMap",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/fall-risk-threshold-vs"
      },
      "name" : "Fall Risk Score Threshold ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Questionnaire/falls-history"
      },
      "name" : "Falls Risk Assessment Questionnaire",
